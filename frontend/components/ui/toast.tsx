...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-lg border bg-card p-4 shadow-lg transition-all",
  {
    variants: {
      variant: {
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 opacity-70 hover:opacity-100",
      className,
    )}
    toast-close=""
    {...props}
